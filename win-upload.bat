...
@REM git push -f https://github.com/Shuaiwen-Cui/Research-SHM_MDOF_Digital_Twin.git main
git push -f https://github.com/Shuaiwen-Cui/Research-SHM_MDOF_Digital_Twin.git main
@REM git remote add origin https://github.com/Shuaiwen-Cui/Research-SHM_MDOF_Digital_Twin.git
