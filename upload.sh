...
# git push -u https://github.com/Shuaiwen-Cui/Research-SHM_MDOF_Digital_Twin.git main
# git remote add origin https://github.com/Shuaiwen-Cui/Research-SHM_MDOF_Digital_Twin.git
